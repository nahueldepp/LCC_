...
/*
para evitar el problema de starvation de los escritores, usamos el metodo de turnstile.
Cremos un semaforo extra, donde los lectores al tomarlo, lo suelten en seguida.Mientras que 
los escritores pueden tomarlo y liberarlo luego de escribir, reteniendo asi a todos los lectores
*/
...
void reader_wait(rw_lock* rwLock){
    ...
    sem_wait(&rwLock->turnstile);
    sem_post(&rwLock->turnstile);
